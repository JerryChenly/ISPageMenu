...
Pod::Spec.new do |s|
  s.name             = 'ISPageMenu'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ISPageMenu.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chenliangyin/ISPageMenu'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chenliangyin' => 'chenliangyin@innotechx.com' }
  s.source           = { :git => 'https://github.com/chenliangyin/ISPageMenu.git', :tag => s.version.to_s }
